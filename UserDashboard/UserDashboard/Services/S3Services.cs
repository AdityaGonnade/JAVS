...
//Service to connect to AWS S3 for image Upload/Download
namespace UserDashboard.Services
{
    public class S3Services
    {
        ...
        public S3Services(string awsAccessKeyId, string awsSecretAccessKey, string region, string bucketName)
        {
